...
export function RegisterComponent({ image, data, custom_class }) {
                                        ...
                                        <div className="wrap d-md-flex">
                                            <div className="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
                                                <div className="text w-100">
                                                    <h2>Register on Filsshop</h2>
                                                    <p>Aalready have an account?</p>
                                                    <Link href="/users/login"><a className="btn btn-light bold-600 w-50">Sign In</a></Link>
                                                </div>
                                            </div>
                                            <div className="login-wrap p-4 p-lg-5">
                                                <div className="d-flex">
                                                    <div className="w-100">
                                                        <h3 className="mb-4 bold-600">Sign Up</h3>
                                                    </div>
                                                    <div className="w-100">
